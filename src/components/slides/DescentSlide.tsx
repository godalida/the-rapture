...
import { Mic, ArrowDown, Users, Bell } from 'lucide-react';
import { BibleVerse } from '../BibleVerse';

export const DescentSlide = () => {
  const points = [
    { 
      title: "The Lord Himself", 
      desc: "1 Thess 4:16, Rev 10:1", 
      icon: <ArrowDown className="w-7 h-7 text-amber-400" />,
      iconBg: "bg-amber-500/10 border-amber-500/20"
    },
    { 
      title: "The Voice", 
      desc: "Gen 3:8, John 1:23, Exodus 3:8", 
      icon: <Mic className="w-7 h-7 text-yellow-400" />,
      iconBg: "bg-yellow-500/10 border-yellow-500/20"
    },
    { 
      title: "The Gathering", 
      desc: "Matt 25:6, The Shout", 
  ...
  return (
    <div className="flex flex-col justify-center h-full px-6 md:px-12 lg:px-24 max-w-7xl mx-auto w-full relative">
      <div className="absolute top-1/2 right-1/4 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] md:w-[600px] md:h-[600px] bg-amber-500/10 blur-[150px] rounded-full pointer-events-none" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16 lg:gap-24 items-center relative z-10">
        ...
        >
          ...
          <p className="text-base md:text-xl lg:text-2xl text-gray-400 font-light leading-relaxed max-w-xl">
            The Lord Himself descends with a shout.
          </p>
        </motion.div>
