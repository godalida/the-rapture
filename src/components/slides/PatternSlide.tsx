...
export const PatternSlide = () => {
  const patterns = [
    { 
      title: "The Greek Harpazo", 
      desc: "1 Thess 4:17", 
      icon: <Zap className="w-7 h-7 text-amber-400" />,
      iconBg: "bg-amber-500/10 border-amber-500/20"
    },
    { 
      title: "The 6 Raptures", 
      desc: "Enoch, Elijah, Jesus, The Saints, The Bride, Two Witnesses", 
      icon: <BookOpen className="w-7 h-7 text-yellow-500" />,
      iconBg: "bg-yellow-500/10 border-yellow-500/20"
    },
    { 
      title: "Mount Transfiguration", 
      desc: "Jesus, Moses, Elijah", 
      icon: <Cloud className="w-7 h-7 text-amber-300" />,
      iconBg: "bg-amber-500/10 border-amber-500/20"
    },
    { 
      title: "The Mystery", 
      desc: "1 Cor 15:51", 
      icon: <Fingerprint className="w-7 h-7 text-yellow-600" />,
      iconBg: "bg-yellow-500/10 border-yellow-500/20"
    }
  ];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16 lg:gap-24 items-center relative z-10">
        ...
        >
          ...
          <p className="text-base md:text-xl lg:text-2xl text-gray-400 font-light leading-relaxed max-w-xl">
            A divine blueprint for the translation of the saints.
          </p>
        </motion.div>
