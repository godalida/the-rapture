...
import { LogOut, ShieldCheck, Heart, Users } from 'lucide-react';
import { BibleVerse } from '../BibleVerse';

export const SeparationSlide = () => {
  const exoduses = [
    { 
      title: "First Exodus", 
      desc: "Israel out of Egypt (Natural)", 
      icon: <LogOut className="w-7 h-7 text-yellow-400" />,
      iconBg: "bg-yellow-500/10 border-yellow-500/20"
    },
    { 
      title: "Second Exodus", 
      desc: "Church out of Judaism (Spiritual)", 
      icon: <Users className="w-7 h-7 text-amber-400" />,
      iconBg: "bg-amber-500/10 border-amber-500/20"
    },
    { 
      title: "Third Exodus", 
      desc: "Bride from the church (Spiritual out of church)", 
      icon: <Heart className="w-7 h-7 text-amber-600" />,
      iconBg: "bg-amber-500/10 border-amber-500/20"
    }
  ];
