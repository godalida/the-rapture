...
import { Fingerprint, Cloud, Zap, BookOpen } from 'lucide-react';
import { BibleVerse } from '../../BibleVerse';

export const MobilePatternSlide = () => {
  const patterns = [
    { title: "The Greek Harpazo", desc: "1 Thess 4:17", icon: <Zap className="w-5 h-5 text-amber-400" /> },
    { title: "The 6 Raptures", desc: "Enoch, Elijah, Jesus, Saints, Bride, Witnesses", icon: <BookOpen className="w-5 h-5 text-yellow-500" /> },
    { title: "Transfiguration", desc: "Jesus, Moses, Elijah", icon: <Cloud className="w-5 h-5 text-amber-300" /> },
    { title: "The Mystery", desc: "1 Cor 15:51", icon: <Fingerprint className="w-5 h-5 text-yellow-600" /> }
  ];
    ...
    <div className="flex flex-col min-h-screen w-full px-6 py-12 relative bg-[#000000]">
      ...
      >
        ...
        <h2 className="text-4xl font-black tracking-tight text-white mb-4">
          Is there a <br/><span className="text-metallic-gold">Pattern?</span>
        </h2>
      </motion.div>
