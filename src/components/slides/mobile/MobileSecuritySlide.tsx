...
import { Lock, Shield, MessageSquareOff } from 'lucide-react';
import { BibleVerse } from '../../BibleVerse';

export const MobileSecuritySlide = () => {
  const points = [
    { title: "The Gap", desc: "Silence between Message and Resurrection", icon: <MessageSquareOff className="w-5 h-5 text-yellow-500" /> },
    { title: "The Pavilion", desc: "Ps 27:1–5, Ps 23:4", icon: <Shield className="w-5 h-5 text-amber-400" /> },
    { title: "The Security", desc: "Eph 4:30, Sealed IN", icon: <Lock className="w-5 h-5 text-yellow-600" /> }
  ];
