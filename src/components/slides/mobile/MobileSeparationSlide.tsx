...
export const MobileSeparationSlide = () => {
  const exoduses = [
    { title: "First Exodus", desc: "Israel out of Egypt (Natural)", icon: <LogOut className="w-5 h-5 text-yellow-400" /> },
    { title: "Second Exodus", desc: "Church out of Judaism (Spiritual)", icon: <Users className="w-5 h-5 text-amber-400" /> },
    { title: "Third Exodus", desc: "Bride from the church (Spiritual out of church)", icon: <Heart className="w-5 h-5 text-amber-600" /> }
  ];
    ...
    <div className="flex flex-col min-h-screen w-full px-6 py-12 relative bg-[#000000]">
      ...
      >
        ...
        <h2 className="text-4xl font-black tracking-tight text-white mb-4">
          Why <br/><span className="text-metallic-gold">Separation?</span>
        </h2>
      </motion.div>
